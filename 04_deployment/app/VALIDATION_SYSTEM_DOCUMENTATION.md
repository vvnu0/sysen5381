...
The script also has a deterministic heuristic reviewer for local testing, but the AI-reviewer mode is the version that demonstrates AI-as-reviewer qualitative content analysis.
...
04_deployment/app/
  ...
  prompt_validation_[experiment.py](http://experiment.py)

  validation_[rubric.md](http://rubric.md)

  VALIDATION_SYSTEM_[DOCUMENTATION.md](http://DOCUMENTATION.md)
  ...
  validation_results/
    ...
    prompt_experiment_summary_20260505_[005644.md](http://005644.md)
